...
struct ConnectorInstance {
    ...
    inline auto phys_read_raw_iter(CIterator<PhysicalReadData> data, ReadFailCallback * out_fail) noexcept {
        int32_t __ret = (this->vtbl_physicalmemory)->phys_read_raw_iter(&this->container, data, out_fail);
        return __ret;
    }

    inline auto phys_write_raw_iter(CIterator<PhysicalWriteData> data, WriteFailCallback * out_fail) noexcept {
