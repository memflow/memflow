...
#[derive(Clone)]
pub struct BridgeServer<T: AccessPhysicalMemoryExt + VirtualAddressTranslator> {
...
where
    T: AccessPhysicalMemoryExt + VirtualAddressTranslator + 'static,
{
...
where
    T: AccessPhysicalMemoryExt + 'static,
{
...
impl<T: AccessPhysicalMemoryExt + VirtualAddressTranslator + 'static> BridgeServer<T> {
...
impl<T: AccessPhysicalMemoryExt + VirtualAddressTranslator + 'static> bridge::Server
    for BridgeServer<T>
{
