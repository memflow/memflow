...
use flow_core::{Address, Architecture, Length, Page, PageType, PhysicalAddress};
                    ...
                    *addr = (base_addr + rng.gen_range(0, 0x2000)).into();
                    (
                        PhysicalAddress {
                            address: *addr,
                            page: Some(Page {
                                page_type: PageType::from_writeable_bit(true),
                                page_base: addr.as_page_aligned(Length::from_kb(4)),
                                page_size: Length::from_kb(4),
                            }),
                        },
                        buf.as_mut_slice(),
                    )
