...
#[cfg(feature = "flow-mmap")]
pub type CoreDump<'a> = flow_mmap::ReadMappedFilePhysicalMemory<'a>;
#[cfg(not(feature = "flow-mmap"))]
pub type CoreDump<'a> = flow_stdio::IOPhysicalMemory<File>;
